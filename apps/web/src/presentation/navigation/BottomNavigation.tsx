import { BookOpen, CalendarDays, HeartPulse, Home, PawPrint } from 'lucide-react';
...
export function BottomNavigation() {
  ...
  return (
    <nav className="fixed inset-x-0 bottom-0 z-30 border-t border-[var(--app-border)] bg-[var(--app-bg)]/96 px-2 pb-[env(safe-area-inset-bottom)] pt-2 backdrop-blur">
